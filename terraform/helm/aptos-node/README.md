...
| fullnode.config | object | `{"default_failovers":0,"max_broadcasts_per_peer":2,"max_inbound_connections":100,"shared_mempool_max_concurrent_inbound_syncs":16}` | Validator configuration. See NodeConfig https://github.com/aptos-labs/aptos-core/blob/main/config/src/config/mod.rs |
